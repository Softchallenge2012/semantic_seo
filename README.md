...
Clustering: Applied density-based clustering using YouTube view counts and duration online to categorize courses into frequently viewed, infrequently viewed, and outliers.

Topic Extraction: Leveraged Large Language Models (LLMs) to extract and summarize key semantic topics across each cluster.
